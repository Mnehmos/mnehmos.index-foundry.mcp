# Deployment Guide for Mnehmos Project Knowledge Base
...
```bash
cd F:\Github\mnehmos.index-foundry.mcp\projects\mnehmos-knowledge-base
npm install
```
...
gh repo create mnehmos-rag-server --public --push
```
...
3. Select your `mnehmos-rag-server` repository
...
3. Copy your URL: `https://mnehmos-rag-server-production.up.railway.app`
