# Deployment Guide for Right-Wing Predators Research
...
```bash
cd F:\Github\mnehmos.index-foundry.mcp\projects\rwp-research
npm install
```
...
gh repo create rwp-research-server --public --push
```
...
3. Select your `rwp-research-server` repository
...
3. Copy your URL: `https://rwp-research-server-production.up.railway.app`
