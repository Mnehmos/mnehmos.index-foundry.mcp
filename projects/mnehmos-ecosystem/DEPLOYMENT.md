# Deployment Guide for Mnehmos Ecosystem Knowledge Base
...
```bash
cd F:\Github\mnehmos.index-foundry.mcp\projects\mnehmos-ecosystem
npm install
```
...
gh repo create mnehmos-ecosystem --public --push
```
...
3. Select your `mnehmos-ecosystem` repository
...
3. Copy your URL: `https://mnehmos-ecosystem-production.up.railway.app`
