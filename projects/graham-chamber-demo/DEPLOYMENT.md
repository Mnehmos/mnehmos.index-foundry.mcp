# Deployment Guide for Graham County Chamber of Commerce - AI Chatbot Demo
...
```bash
cd C:\Users\mnehm\AppData\Roaming\Roo-Code\MCP\IndexFoundry\projects\graham-chamber-demo
npm install
```
...
gh repo create graham-chamber-chatbot --public --push
```
...
3. Select your `graham-chamber-chatbot` repository
...
3. Copy your URL: `https://graham-chamber-chatbot-production.up.railway.app`
