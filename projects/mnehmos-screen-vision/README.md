# Mnehmos Screen Vision Knowledge Base

Knowledge base for the screen.vision Tauri desktop conversion project. Contains project reviews, architecture decisions, and development notes.
...
|----------|----------|-------------|
| `PORT` | No | HTTP server port (default: 8765) |
