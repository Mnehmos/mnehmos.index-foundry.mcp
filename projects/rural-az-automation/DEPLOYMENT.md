# Deployment Guide for Rural Arizona Business Automation with AI Agents
...
```bash
cd C:\Users\mnehm\AppData\Roaming\Roo-Code\MCP\IndexFoundry\projects\rural-az-automation
npm install
```
...
gh repo create rural-az-automation-server --public --push
```
...
3. Select your `rural-az-automation-server` repository
...
3. Copy your URL: `https://rural-az-automation-server-production.up.railway.app`
