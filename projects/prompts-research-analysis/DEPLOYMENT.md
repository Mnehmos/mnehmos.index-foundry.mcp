# Deployment Guide for Prompt Engineering Research Analysis
...
```bash
cd F:\Github\mnehmos.index-foundry.mcp\projects\prompts-research-analysis
npm install
```
...
gh repo create prompts-research-analysis --public --push
```
...
3. Select your `prompts-research-analysis` repository
...
3. Copy your URL: `https://prompts-research-analysis-production.up.railway.app`
