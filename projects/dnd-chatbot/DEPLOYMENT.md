# Deployment Guide for D&D 5e Chatbot
...
```bash
cd C:\Users\mnehm\AppData\Roaming\Roo-Code\MCP\IndexFoundry\projects\dnd-chatbot
npm install
```
...
gh repo create dnd-chatbot --public --push
```
...
3. Select your `dnd-chatbot` repository
...
3. Copy your URL: `https://dnd-chatbot-production.up.railway.app`
